...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
    ...
    self.window.rootViewController = self.listStory;
    [self.window makeKeyAndVisible];
    // application.applicationIconBadgeNumber = 0;

    self.listStory = [[ListViewController alloc] init];
    navigation=[[UINavigationController alloc]initWithRootViewController:self.listStory];
